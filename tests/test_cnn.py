...
class TestDataset:
    ...
    def test_dataloader_yields_correct_shapes(self):
        train, _, _, num_classes = create_dataloaders(
            "D:/datasets/oxford-iiit-pet", batch_size=4
        )
...
class TestInference:
    ...
    def test_predict_breed_success(self):
        ...
        candidates = _g.glob("D:/datasets/oxford-iiit-pet/images/*.jpg")
        if not candidates:
